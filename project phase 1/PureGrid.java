...
public class PureGrid {
	...
	private static List<Vm> vmlist;
        ...
        {      
	            	...
	            	boolean trace_flag = true;  // mean trace events
                        ...
                        final double datacenter_power_cost[]=new double[10];
				...
				public void run() {
					...
					try {
						...
						e.printStackTrace();
                                        ...
                                        printCloudletList(broker.getCloudletReceivedList(),datacenter_power_cost);
			...
			Thread.sleep(100);
	            	...
	            	printCloudletList(newList,datacenter_power_cost);
	...
	private static DatacenterBroker createBroker(int id){
        ...
        private static void printCloudletList(List<Cloudlet> list,double cost[]) {
	        int size = list.size();
	        Cloudlet cloudlet;
